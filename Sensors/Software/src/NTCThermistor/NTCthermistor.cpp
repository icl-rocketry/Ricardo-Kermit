...
NTCThermistor::NTCThermistor(ADS1219 *ADS, const uint32_t Rfixed, const uint32_t Rseriesextra, const float gradient, const float Cconstant, uint8_t ADCchannel) : _ADS(ADS)
{
    grad = gradient;
    constant = Cconstant;
    RFixedPD = Rfixed;
